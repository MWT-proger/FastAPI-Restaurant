...
from api.v1.schemas.submenu import (
    SubmenuCreate,
    SubmenuResponse,
    SubmenuUpdate,
...
from services.submenu import SubmenuService, get_submenu_service
...
async def create_submenu(
    menu_id: uuid.UUID,
    submenu_content: SubmenuCreate = Body(None, examples=SubmenuCreate.Config.json_schema_extra["examples"]),
    submenu_service: SubmenuService = Depends(get_submenu_service),
) -> SubmenuResponse:
...
async def patch_submenu(
    menu_id: uuid.UUID,
    submenu_id: uuid.UUID,
    submenu_content: SubmenuUpdate = Body(None, examples=SubmenuUpdate.Config.json_schema_extra["examples"]),
    submenu_service: SubmenuService = Depends(get_submenu_service),
) -> SubmenuResponse:
